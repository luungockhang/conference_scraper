...
# Don't change these paths, please. PC will burn and melt.
...
input_file5 = 'conference_list_site/ccfddl.github.io/output.csv'
file_path1 = 'proc1.csv'
file_path2 = 'proc2.csv'
file_path3 = 'proc3.csv'
file_path4 = 'proc4.csv'
file_path5 = 'proc5.csv'
...
async def combine():
    ...
    #0Title, 1Place, 2Deadline, 3Date, 4Web, 5Description
    df5 = pd.read_csv(input_file5, header=0, skiprows=0)
    df5.to_csv(os.path.join(folder_path,file_path5),index=False)
